...
<option value="Water Softener & Bathroom Water Softener" <?php if($row['task_type']=="Water Softener & Bathroom Water Softener") echo "selected"; ?>>Water Softener & Bathroom Water Softener</option>
<option value="Industrial RO Plants" <?php if($row['task_type']=="Industrial RO Plants") echo "selected"; ?>>Industrial RO Plants</option>
<option value="DMF & IRON Removal" <?php if($row['task_type']=="DMF & IRON Removal") echo "selected"; ?>>DMF & IRON Removal</option>
<option value="Alkaline Ionizer" <?php if($row['task_type']=="Alkaline Ionizer") echo "selected"; ?>>Alkaline Ionizer</option>
<option value="Alkaline Water Purifiers" <?php if($row['task_type']=="Alkaline Water Purifiers") echo "selected"; ?>>Alkaline Water Purifiers</option>
<option value="Domestic RO" <?php if($row['task_type']=="Domestic RO") echo "selected"; ?>>Domestic RO</option>
<option value="Commercial RO" <?php if($row['task_type']=="Commercial RO") echo "selected"; ?>>Commercial RO</option>
